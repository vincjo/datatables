...
<style>
    ...
    nav{position:relative;overflow-x:auto;width:100%;height:40px;background:#000;border:none;box-shadow:none;padding:8px 4px 0px 4px;}
    ul{display:flex;align-items:flex-end;color:#9e9e9e;margin:0;padding:0 8px;list-style-type:none;font-family:'Lucida Sans', 'Lucida Sans Regular', 'Lucida Grande', 'Lucida Sans Unicode', Geneva, Verdana, sans-serif;font-size:12px;height:100%;}
    li{cursor:pointer;padding:2px 8px;transition:all,0.2s;display:flex;justify-content:flex-start;align-items:center;height:32px;margin:0 2px;}
    li:hover{background:#2f2f2f;}
    li.active{color:#e0e0e0;background:#2f2f2f;}
