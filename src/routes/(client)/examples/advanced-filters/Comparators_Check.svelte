<script>
<<<<<<< HEAD:src/routes/examples/advanced-filters/Comparators_Check.svelte
    import { DataHandler, check } from '$lib/core'
=======
    import { DataHandler, check } from '$lib'
>>>>>>> upstream/master:src/routes/(client)/examples/advanced-filters/Comparators_Check.svelte
