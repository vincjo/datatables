...
<section>
    <div class="flex">
        <div>
            ...
            <article class="flex">
                <aside onmouseenter={() => site.setMode('client')} class={[ 'flex', { active: site.mode === 'client' }]}>
                    ...
                    <div class="flex">
                        <a href="{path.get('/docs/client/getting-started/intro')}">Docs</a>
                        <a href="{path.get('/examples/client/hello-world')}">Examples</a>
                        <a href="{path.get('/api/client')}">API</a>
                    </div>
                </aside>
                <aside onmouseenter={() => site.setMode('server')} class={[ 'flex', { active: site.mode === 'server' }]}>
                    ...
                    <div class="flex">
                        <a href="{path.get('/docs/server/getting-started/intro')}">Docs</a>
                        <a href="{path.get('/examples/server/hello-world')}">Examples</a>
                        <a href="{path.get('/api/server')}">API</a>
                    </div>
                </aside>
            </article>
        </div>
